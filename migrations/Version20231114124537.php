 ...
 */
final class Version20231114124537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE conversation ADD last_message_id INT NOT NULL, ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE message DROP FOREIGN KEY FK_B6BD307FF675F31B');
        $this->addSql('DROP INDEX IDX_B6BD307FF675F31B ON message');
        $this->addSql('ALTER TABLE message DROP destinataires, CHANGE author_id user_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE conversation DROP last_message_id, DROP user_id');
        $this->addSql('ALTER TABLE message ADD destinataires LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE user_id author_id INT NOT NULL');
